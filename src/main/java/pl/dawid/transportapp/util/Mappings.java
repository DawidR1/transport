package pl.dawid.transportapp.util;

public class Mappings {
    public static final String RESOURCE_URL = "/resource/";
    public static final String DRIVER_URL = "/driver";
    public static final String ID_PATH = "/{id}";
    public static final String CAR_URL = "/car";
    public static final String FILE_URL = "/file";
    public static final String CROSS_ORIGIN_FRONT = "https://transport-rych-view.herokuapp.com";
